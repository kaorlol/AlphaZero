...
local File = loadstring(game:HttpGet(("https://raw.githubusercontent.com/Sw1ndler/AlphaZero/main/Handlers/File.lua")))();
...
File:QueueDownload("AlphaZero/Loader.lua", "https://raw.githubusercontent.com/Sw1ndler/AlphaZero/main/Loader.lua", true);

for _, Game in next, File:GetFilesFrom("https://github.com/Sw1ndler/AlphaZero/tree/main/Games") do
    local Name = Game:match("([^/]+)$");
    local Url = "https://raw.githubusercontent.com/Sw1ndler/AlphaZero/main/Games/"..Name;
